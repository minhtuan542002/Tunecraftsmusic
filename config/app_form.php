...
return [
    ...
    /**
     * This hierarchy (i.e. FormTemplates => Default) is completely arbitrary. I've named it this so that I can
     * refer to it later by going $this->Form->setTemplates(Configure::read('FormTemplates.Default').
     */
    'FormTemplates' => [
        'Default' => [
